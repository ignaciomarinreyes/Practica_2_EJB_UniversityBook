...
public class ProgramPublish extends FrontCommand {
    ...
    public void process() {
        ...
        postUserBean.programPost(Integer.parseInt(request.getParameter("miliseconds")),(String) request.getParameter("title"), (User) request.getSession().getAttribute("user"), LocalDate.now(), (String) request.getParameter("content"), null, Integer.valueOf(request.getParameter("subject")));
